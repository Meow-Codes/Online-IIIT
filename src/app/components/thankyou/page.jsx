...
const ThankYouPage = () => {
  return (
    <>
      ...
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden px-3 md:px-0">
        ...
        <div className="relative z-10 bg-[#204d65] backdrop-blur-md rounded-3xl w-full md:w-[600px] shadow-lg p-8 text-center">
          ...
          <p className="text-white/80 mb-4 text-2xl font-bold">
            Our team will reach out to you shortly for <br /> further
            assistance.
          </p>
          <p className="text-white/80 mb-6 text-xl font-semibold">
            To proceed, please complete your application.
          </p>
          <Link href="/application">
            {" "}
            <button className="bg-[#FFFFFF] text-[#041b39] font-semibold py-3 px-10 rounded-full cursor-pointer">
              Apply Now
            </button>
          </Link>
        </div>
